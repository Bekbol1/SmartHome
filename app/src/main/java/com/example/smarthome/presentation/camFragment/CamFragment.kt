...
import com.example.smarthome.databinding.FragmentCamBinding
...
@AndroidEntryPoint
class CamFragment : BaseFragment<FragmentCamBinding>() {

    private val viewModel: CamViewModel by viewModels()

    private val adapter = CamAdapter()
    override fun inflateViewBinding(): FragmentCamBinding =
        FragmentCamBinding.inflate(layoutInflater)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        itemTouchHelper.attachToRecyclerView(binding.rvCam)
    }
